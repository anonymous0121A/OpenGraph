...
class DataHandler:
    ...
    def get_data_files(self):
        if self.data_name.startswith('gen_data'):
            data_name = self.data_name[:self.data_name.index('-iter')]
            gen_iter = int(self.data_name[self.data_name.index('-iter') + len('-iter'):])
            predir = f'../GPT_generation/gen_results/datasets/{data_name}/res/iter-{gen_iter}_'
            self.trnfile = predir + 'train.pkl'
            self.valfile = predir + 'valid.pkl'
            self.tstfile = predir + 'test.pkl'
        elif self.data_name == 'spyelp':
            predir = '/home/user_name/data/sparse datasets/sparse_yelp/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.valfile = predir + 'val_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'spgowalla':
            predir = '/home/user_name/data/sparse datasets/sparse_gowalla/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.valfile = predir + 'val_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'spamazon':
            predir = '/home/user_name/data/sparse datasets/sparse_amazon/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.valfile = predir + 'val_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'ml1m':
            predir = '/home/user_name/data/unlearning datasets/ml-1m/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
            self.valfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'ml10m':
            predir = '/home/user_name/data/unlearning datasets/ml-10m/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
            self.valfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'yelp2018':
            predir = '/home/user_name/data/unlearning datasets/yelp2018/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
            self.valfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'gowalla':
            predir = '/home/user_name/data/lightgcn data/gowalla/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
            self.valfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'amazon-book':
            predir = '/home/user_name/data/lightgcn data/amazon-book/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
            self.valfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'collab':
            predir = '/home/user_name/data/zero-shot datasets/collab/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
            self.valfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'ddi':
            predir = '/home/user_name/data/zero-shot datasets/ddi/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
            self.valfile = predir + 'tst_mat.pkl'
        elif self.data_name == 'ppa':
            predir = '/home/user_name/data/zero-shot datasets/ppa/'
            self.trnfile = predir + 'trn_mat.pkl'
            self.tstfile = predir + 'tst_mat.pkl'
            self.valfile = predir + 'tst_mat.pkl'
