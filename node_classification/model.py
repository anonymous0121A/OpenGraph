...
class GraphGPT(nn.Module):
    ...
    def pred_for_test(self, batch_data, adj, initial_projector, rerun_embed=True):
        ...
        cand_embeds = final_embeds[-trn_mask.shape[1]:]
        all_preds = anc_embeds @ cand_embeds.T * (1 - trn_mask) - trn_mask * 1e8
        return all_preds
