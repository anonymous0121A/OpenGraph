...
class DataHandler:
    ...
    def get_data_files(self):
        predir = f'/home/user_name/data/zero-shot node datasets/{self.data_name}/'
        self.adj_file = predir + f'adj_{args.shot}.pkl'
        self.label_file = predir + 'label.pkl'
        self.mask_file = predir + f'mask_{args.shot}.pkl'
